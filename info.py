...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001779994721').split()]
...
BASE_URL = ('https://dadabhai.onrender.com')
...
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "⚡uploaded by [TN 68 FILM FACTORY](https://t.me/TN68_FilmFactory)</b>⚡\n\nName: {file_caption} \n\n⚙️ <b>Size: </b><code>{file_size}</code>🔥  ↭ <b>Join Now [TN 68 FILM FACTORY](https://t.me/TN68_FilmFactory)</b> ↭  🔥")
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'hypershort.com')
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'adc8e1d29caf28e5369ec99dd472aef6ccf8985b')
